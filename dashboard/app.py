...
if page == "Executive Overview":
    ...
    st.caption(
        "Notice the risk spikes aligning with real-world-style disruption windows built into the "
        "simulation (e.g. chip shortage tail in 2022, Red Sea shipping disruption late 2023, "
        "tariff escalation in 2025) — this is intentional so you can discuss how macro shocks "
        "propagate into vendor scorecards."
    )
